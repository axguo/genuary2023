  ...
  for (let i = 0; i < boxes.length; i++) {
    ...
    if (b.show) {
      ...
      if (b.drop) {
        ...
        screen.rotateX(b.x * frameCount);
        screen.rotateY(b.y * frameCount);
        screen.rotateZ(b.z * frameCount);
        b.y -= 25;
      } else {
      ...
      screen.sphere(b.l, 16, 16);
      screen.pop();

      if (noise > 0.2 && random() < 0.25) {
        // b.show=false;
        b.drop = true;
      }
    }
...
function setup() {
  ...
  screen.stroke(100, 0, 0);
  screen.fill(227, 91, 73);
  frameRate(10);
